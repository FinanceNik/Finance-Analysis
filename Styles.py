...
def empty_state(message="No data available", icon="\U0001F4CA"):
    return html.Div([
...
def _format_kpi_value(value):
    """Format numeric KPI values with thousands separators.
    Integers and floats with no fractional part omit decimals.
    """
